module github.com/OpenClaw-Security/Stealth-Core/adapters/redteam_tools
...
replace github.com/OpenClaw-Security/Stealth-Core/pkg/proto/redteam_tools => /home/kali/.openclaw/workspace/chimera_project/pkg/proto/redteam_tools
